...
const AppBotaoSelecionarInstituicaoLink = forwardRef<any, IUIExplorerLinkProps>(
  (props, ref) => <UIExplorerLink ref={ref} ignore={['ue']} {...props} />,
);

AppBotaoSelecionarInstituicaoLink.displayName =
  AppBotaoSelecionarInstituicaoLink.name;
